...
function Navmobile(props) {
    ...
    return(
        <Mobile style={mobile}>
            ...
            <Menu>
                <Men>
                    <Title><p>Mężczyzna</p></Title>
                    <div>
                    <DropElement onClick={handleSlide}>BUTY
                            <UlIn>
                            <LiIn>Bieganie</LiIn>
                    ...
                    <DropElement onClick={handleSlide}>ODZIEŻ
                        <UlIn>
                            <LiIn>Koszulki</LiIn>
                            <LiIn>Bluzy</LiIn>
                            <LiIn>Swetry</LiIn>
                    ...
                    <DropElement  onClick={handleSlide}>WYPRZEDAŻ
                        <UlIn>
                            <LiIn>Dresy</LiIn>
                            <LiIn>Legginsy</LiIn>
                            <LiIn>Koszulki</LiIn>
